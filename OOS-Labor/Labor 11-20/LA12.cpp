...
public:
	D1(int c2_a = 0xD1C2A, int c3_a = 0xD1C3A, 
		...
		: A(0xD1A), C3(c3_a, c3_b) {} // A und B sind virtuell -> Anpassung der Initialisierung, Nutzung von hex-Werten als "Marker"
	void print() {
		cout << "D1::print() ..." << endl;
...
public:
	D2(int c1_a = 0xD2C1A, int c2_a = 0xD2C2A, int c3_a = 0xD2C3A,
			...
			: A(0xA), B(0xD2C2A, 0xD2B), C1(c1_a, c1_b), C2(c2_a, c2_b), C3(c3_a, c3_b) {} // auch hier: Nutzung von hex-Werten als "Marker"
